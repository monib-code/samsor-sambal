...
import { Building2, Pencil, Trash2, Search, X } from "lucide-react";

const CompanyList = () => {
  const [search, setSearch] = useState("");
  const [editItem, setEditItem] = useState(null);
  const [companies, setCompanies] = useState([
    { id: 1, name: "شرکت الف", phone: "0790000001", address: "کابل" },
    { id: 2, name: "شرکت ب", phone: "0782222222", address: "مزار" },
    { id: 3, name: "شرکت پ", phone: "0703333333", address: "هرات" },
  ]);
  ...
  return (
    <div className="space-y-4 text-right rtl">
      <h2 className="text-2xl font-bold text-teal-700 dark:text-teal-400 flex items-center justify-end gap-2">
        <Building2 size={24} /> لیست شرکت‌ها
      </h2>
